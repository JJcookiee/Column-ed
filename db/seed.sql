...
insert into media(media_id,title,decr,media_type,release_date) values(1,'test book','does not exist',4,'2025-12-02');

insert into books(book_id,auhtor,publisher,pages,chapters,media_id) values(1,'me','also me',1,1,1);
